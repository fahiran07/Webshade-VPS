				...
				dataTable.innerHTML = data.search_result
					.map(
						...
						<tr>
            				...
            				<td id="status-${connect.connect_id}">
            				    ${connect.status === "Offline" ? '<span class="text-danger">' + connect.status + "</span>" : '<span class="text-success">' + connect.status + "</span>"}
            				</td>
            				...
            				<td><a href="/admin/webshadeApp/whatsappconnection/${connect.id}/change/" target="_blank">EDIT</a></td>
       					</tr>
				`
					)
					.join("");
